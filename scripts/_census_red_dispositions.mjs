...
const LEDGER = [
  ...
  { gate: '_gate_rollover_countonce.js', legs: '2 of 8',
    disposition: 'UNRULED — needs the Architect', owner: 'Architect',
    evidence: 'default payload counts ONE balance ($100k, not $208k) · standalone opt-in restores the Conduit ($208k)',
    green_when: 'somebody rules whether a rollover 401(k) counts once or twice by default. ⛔ THIS IS MONEY: $108,000 of portfolio turns on it, and the gate cannot be dispositioned without the ruling. NOT A REPAIR UNTIL THE CORRECT ANSWER IS STATED.' },
