...
let body = ['_monthsBetween', 'lifeOfLoan', 'lifetimeInterest', '_moatNegAm', '_retireInfo', '_targetPayment', '_payoffYearOf', '_moatSanePayoff', '_moatDI'].map(n => extractFn(src, n)).join('\n');   // §19.9 _moatNegAm · §19.10 _retireInfo/_targetPayment/_payoffYearOf
