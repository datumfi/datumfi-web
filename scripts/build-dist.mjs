...
const SACRED = {
  ...
  'studio.html': 'a7e783279583a3fbea12ceda72e251a7',// ⛔⛔ THE RESTORE BANNER LEAVES AS ONE UNIT — 5s hold, 0.5s fade, notice AND action together. Previously the notice faded at 9s and THE BUTTON STAYED FOREVER: measured at ~11s it was 124px wide, re-centred x 443-997 -> x 658-782, and its ONLY exit was to be PRESSED — which DISCARDED the fields that had just been restored. A control that cannot be dismissed is FURNITURE; the rail rejected furniture and this arrived as furniture by another door. ⛔ The superseded law ('a notice may expire; an action may not') is STRUCK IN PLACE rather than deleted, in BOTH studio.html and the gate header — the reasoning was sound and the implementation was not what it described. ⛔ THE 5s IS THE CAPTAIN'S, READ ON A REAL SCREEN, OVERRULING '~10s is by design': an argument lost to an observation. ⛔ The MutationObserver is disconnected WITH the removal — left armed over a removed node it re-places the banner for the life of the page, and 'nothing stranded' must include machinery or it only means pixels. ⚠ NAMED RESIDUAL, ACCEPTED KNOWINGLY: with the action gone there is no route back to a fresh start until '<- Overview' is the permanent door — queued, and now load-bearing. Gate: _gate_restore_banner_placement.js L3a/L3b REPLACE the superseded L3 (RED-FIRST: the old L3 printed actionPresent=false against these bytes while the other five legs stayed GREEN; the amputation control re-stranded the button and printed banner=true notice=false orphanActions=1). Supersedes the F56/F47 wake note at a0d2317. (2026-09-01)
