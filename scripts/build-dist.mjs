...
const SACRED = {
  ...
  'studio.html': '3695a2536397bb637c34b493a9934d53',// ⛔ FINDING 63 — THE PRODUCT WAS WRONG ABOUT WHAT DAY IT IS, FOR FOUR HOURS OF EVERY DAY. _monthsBetween parses both arguments with T00:00:00 (LOCAL), but the elapsed-months call rendered today via new Date().toISOString().slice(0,10) — which is UTC. MEASURED 2026-08-31 at 20:25 EDT: local 2026-08-31, UTC 2026-09-01; a 240-month mortgage originating 2006-08-01 read elapsed=241, PAST TERM, on the last day of its final month. ⚠️ Wrong for the last 4h of every day in a UTC-negative timezone, and wrong BY A MONTH for those hours at each month end — on the screen that says whether a mortgage has finished. 🔑 THE BUG IS THE SEAM, NOT EITHER SIDE: build and compare in one frame. Do not simplify _todayLocalISO back to toISOString — that is a timezone conversion wearing a formatting costume, invisible 20 hours out of 24. FOUND BY _gate_407_20_2b_pastterm going RED at 20:22 after three GREEN runs the same evening; proven foreign by swapping studio.html for HEAD bytes and reproducing it there. ⛔ AND ITS GUARD REMOVES THE WINDOW: scripts/_gate_local_date_frame.mjs stubs a clock whose LOCAL and UTC days disagree, so the property is asserted on every run, any date, any timezone — the 407 gate could only see this ~4 hours a month. (2026-08-31)
