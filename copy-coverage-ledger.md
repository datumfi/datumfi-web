...
**401(k) room status:** reduced surface (JOB A) + ① D144 + copy reconcile + ② Why-panel + ③ col-tips = wired & gated. **Only ④ §19 §Rollup-Parity remains (HOLD — needs the field-by-field §1-live-vs-§19 diff + Captain per-field ruling; two-versions trap).**
